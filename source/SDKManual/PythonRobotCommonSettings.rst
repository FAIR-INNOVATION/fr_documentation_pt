...
.. csv-table:: 
    ...
    "Protótipo", "``SetSpeedInstant(self, vel)``"
    "Descrição", "Definição de velocidade em tempo real (quadro de comando, baixa latência)"
    "Parâmetros Obrigatórios", "
...
.. csv-table:: 
    ...
    "Protótipo", "``SetWeaveOffsetRT(self, offset)``"
    "Descrição", "Define o deslocamento em tempo real da oscilação"
    "Parâmetros Obrigatórios", "
