...
.. code-block:: Java
    ...
    /*
    * @brief  Definir Velocidade Durante a Execução da Trajetória
    * @param  ovl Percentual de velocidade
    * @param  mode Modo; 0-modo de redução de velocidade; 1-comutação direta
    * @return  Código de erro
    */
...
Exemplo de código para definir a velocidade durante a execução da trajetória do robô
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
